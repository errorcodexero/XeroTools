...
namespace PathViewer
{
    public partial class BasicFieldView : UserControl
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            PointF ept = new PointF(e.X, e.Y);
            PointF wpt = WindowToWorld(ept);
            PointF bpt = WorldToWindow(wpt);
            FieldMouseMovedArgs args = new FieldMouseMovedArgs(wpt, ept, bpt);
            OnFieldMouseMoved(args);
        }
